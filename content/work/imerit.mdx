...
<figure className="work-visual">
  <img src="/images/work/imerit/ground-control-edge-case-module.webp" alt="Ground Control screenshot-governance workflow for allowlisted and blocklisted customers across Custom Configuration, AWS, and the Edge Case Module" />
