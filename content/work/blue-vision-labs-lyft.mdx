...
hero: I helped scale camera-based mapping from three city pilots into a two-country operation that supplied a 3D map pipeline for Lyft Level 5.
...
A mapping program is only as good as the data that survives the trip back. Four things had to hold:

- **Capture had to survive real conditions.** Heat, tunnels, bad lighting, mounting variation, and driver behavior all had to be handled by the rig, not designed around.
- **Collected had to mean usable.** Volume was not the metric. Data had to be good enough for the downstream mapping pipeline to actually consume.
- **Cost had to stay below dedicated mapping vehicles.** The entire premise was camera phones in ordinary fleet vehicles instead of specialized lidar rigs.
- **Privacy had to hold across two jurisdictions.** Street-level camera capture in the U.S. and U.K. had to satisfy both, not just one.
